  ...
  return (
    <main className={`flex-grow ${darkMode ? "bg-gray-900 text-white" : "bg-gradient-to-br from-indigo-500 via-purple-500 to-pink-500 text-gray-900"}`}>
      <div className="max-w-3xl mx-auto p-8">
        ...
        <h2 className="text-2xl font-bold mt-6 mb-3 text-white">⚡ Simplicity & Speed</h2>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-3 text-white">🌍 Global Usage</h2>
        <p className={`mb-4 text-lg leading-relaxed ${darkMode ? "text-gray-300" : "text-white/90"}`}>
        ...
        <h2 className="text-2xl font-bold mt-6 mb-3 text-white">🔧 Continuous Improvement</h2>
        <p className={`mb-4 text-lg leading-relaxed ${darkMode ? "text-gray-300" : "text-white/90"}`}>
        ...
        <p className={`text-lg leading-relaxed font-medium mt-6 text-center ${darkMode ? "text-gray-200" : "text-white/95"}`}>
